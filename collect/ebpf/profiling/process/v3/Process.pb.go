...
type EBPFProcessPingPkg struct {
	...
	// Process id assigned by OAP server.
	ProcessId string `protobuf:"bytes,1,opt,name=processId,proto3" json:"processId,omitempty"`
}
...
func (x *EBPFProcessPingPkg) GetProcessId() string {
	if x != nil {
		return x.ProcessId
	}
	return ""
...
var file_ebpf_profiling_Process_proto_rawDesc = []byte{
	...
	0x6b, 0x67, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x73, 0x22, 0x32, 0x0a,
	0x12, 0x45, 0x42, 0x50, 0x46, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x50, 0x69, 0x6e, 0x67,
	0x50, 0x6b, 0x67, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x49, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x49,
	0x64, 0x32, 0xca, 0x01, 0x0a, 0x12, 0x45, 0x42, 0x50, 0x46, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73,
...
var file_ebpf_profiling_Process_proto_depIdxs = []int32{
	...
	0,  // 8: skywalking.v3.EBPFProcessService.reportProcesses:input_type -> skywalking.v3.EBPFProcessReportList
	9,  // 9: skywalking.v3.EBPFProcessService.keepAlive:input_type -> skywalking.v3.EBPFProcessPingPkgList
	5,  // 10: skywalking.v3.EBPFProcessService.reportProcesses:output_type -> skywalking.v3.EBPFReportProcessDownstream
	11, // 11: skywalking.v3.EBPFProcessService.keepAlive:output_type -> skywalking.v3.Commands
